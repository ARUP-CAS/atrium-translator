...
*Timeline index refreshed 2026-08-02 against `test` HEAD and the refreshed digest/plan. Nothing removed from the
issue itself (per hub #29); this file is a derived reading aid in `agent_dev_logs/`.*
